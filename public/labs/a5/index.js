...
//console.log(`(${numberArray1.length}) ${JSON.stringify(numberArray1)}`);
//console.log(`(${stringArray1.length}) ${JSON.stringify(stringArray1)}`);
//console.log(`(${stringArray1.length}) ${JSON.stringify(stringArray1)}`);
//console.log(variableArray1.map(item => Array.isArray(item) ? `Array(${item.length})` : item));
...
//console.log(`(${squares.length}) ${JSON.stringify(squares)}`);
//console.log(`(${cubes.length}) ${JSON.stringify(cubes)}`);
console.log(squares);
console.log(cubes);
